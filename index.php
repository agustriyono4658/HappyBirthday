...
<body>
   ...
   <!-- Ganti Audio di sini -->
   <audio src="hbd.mp3" id="linkmp3" class="sembunyi"></audio>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq' data-text='㋡'>
       ...
       <!-- Pesan -->
       <p id="pesan3">Ciee.. Ada yang ulang tahun Nih yee 🤣❤️</p>
       <p id="pesan4">Happy Birthday Sayangku, </p>
       <p id="pesan5" class="gaya2">Nambah tua aja sayangnya aku ini ya, hehe</p>
       <p id="pesan6" class="gaya2">Moga panjang umur yaa wkwk 😆❤️</p>
       <p id="pesan7" class="gaya2">Sehat selalu ya!</p>

       <p id="pesan8" class="gaya2">Canda wkwk :v</p>
       <p id="pesan9" class="gaya2">Oh iya, semoga di hari spesialmu ini kamu dapat menjadi pribadi yang lebih baik, dimudahkan segala urusannya, dilancarkan rezekinya dan cepet selesai semua masalahnya. AMIN!!! 🥳❤️</p>
...
<script>
  ...
  var tomnegatif = 'Engga';
    ...
    async function menuju(){pesanwhatsapp = "Terima Kasih sayangkuhhh ><";await swals.fire('OK!', 'Kirim jawabannya ke WhatsApp aku, ya!', 'success');window.location = "https://api.whatsapp.com/send?phone=6285959690173&text=" + pesanwhatsapp;}
</script>
