function initengahan(){
  ...
  function kethalo(){new TypeIt("#halo", {strings: ["" + vketikhalo], startDelay: 50, speed: 40, waitUntilVisible: true, afterComplete: function(){halo.innerHTML = vketikhalo;setTimeout(bqmuncul,700);},}).go();}
  ...
  new TypeIt("#kalimat", {
  strings: ["" + vketik1], startDelay: 800, speed: 50, cursor: false, deleteSpeed: 20, breakLines: false, waitUntilVisible: true, lifelike: true,
  ...
  function otomatis(){pesan3.style="transition:none";pesan8.style="display:none";kalimat.style="opacity:0";if(otoaktipesan==0){setTimeout(otolanj,1000)}}
  ...
  afterComplete: function(){
    pesan3.innerHTML=vketik3;setTimeout(otomatis,1000);setTimeout(aktipesan4,1010);
  },}).go();
  }
  function aktipesan4(){
    wallpaper.style="transform: scale(1.5);";kalimat.innerHTML=pesan4.innerHTML + nama + " 🥳";kalimat.style="transform:scale(1.2)";setTimeout(aktipesan5,1500);
  }
  vketik5=pesan5.innerHTML;pesan5.innerHTML="";
  function aktipesan5(){
  fthilang();ftganti=3;setTimeout(ftmuncul,1000);
  wallpaper.style="transform: scale(1);";
  new TypeIt("#pesan5", {
  strings: ["" + vketik5], startDelay: 1, speed: 52, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan5.innerHTML=vketik5 + " ><";setTimeout(aktipesan6,1000);
  },}).go();
  }
  ...
  afterComplete: function(){
    pesan6.innerHTML=vketik6;setTimeout(aktipesan7,1000);
  },}).go();
  }
  ...
  afterComplete: function(){
    pesan7.innerHTML=vketik7;fungsi=1;setTimeout(tombol,800);
  },}).go();
  }
  //Pemisah
  ...
  ftganti=4;ftmuncul();
  new TypeIt("#pesan8", {
  strings: ["" + vketik8, "" + vketik9], startDelay: 40, speed: 60, cursor: true, deleteSpeed: 40, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    pesan8.innerHTML=vketik9;setTimeout(otomatis,5000);setTimeout(aktipesan10,3000);
  },}).go();
  }
  function aktipesan10(){
    ...
    fungsi=2;setTimeout(tombol,400);
  }
  var otoaktipesan=0;
